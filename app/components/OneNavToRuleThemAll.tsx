...
function OneNavToRuleThemAll() {
  ...
  return (
    <nav className={navClasses}>
      <div className="flex">
        <a className="absolute top-4 inline-block lg:block z-30 lg:z-10">
          <Logo className={whiteToBlackClasses} />
        </a>
        <button
          className={classNames(
            'flex items-center lg:hidden ml-20 z-30 lg:z-0',
            whiteToBlackClasses
          )}
      ...
      <div className={navLinksContainerClasses}>
        <ul className={desktopNavClasses}>
          ...
          <li className="ml-auto">
            <a className="lg:text-blue lg:text-sm xl:text-lg" href="#">
